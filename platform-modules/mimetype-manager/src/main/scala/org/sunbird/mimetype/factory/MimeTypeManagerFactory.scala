...
import org.sunbird.mimetype.mgr.impl.{ApkMimeTypeMgrImpl, AssetMimeTypeMgrImpl, CollectionMimeTypeMgrImpl, DefaultMimeTypeMgrImpl, DocumentMimeTypeMgrImpl, EcmlMimeTypeMgrImpl, H5PMimeTypeMgrImpl, HtmlMimeTypeMgrImpl, PluginMimeTypeMgrImpl, QtiMimeTypeMgrImpl, ScormMimeTypeMgrImpl, YouTubeMimeTypeMgrImpl}
...
object MimeTypeManagerFactory {
	...
	def getManager(objectType: String, mimeType: String)(implicit ss: StorageService): MimeTypeManager = {
		...
		val mimeTypeMgr = Map[String, MimeTypeManager](
			...
			"application/vnd.ekstep.qti-archive" -> new QtiMimeTypeMgrImpl,
